...
// Operadores elacionais: Um operador relacional compara seus operando e retorna um valor booleano baseado em se a comparação é verdadeira.

{
// Valores literais:
    console.log(8 < 22); // < menor
    console.log(6 <= 9); // <= menor ou igual
    console.log(19 > 21); // > maior
    console.log(27 >= 29); // >= maior ou igual
    console.log(7 == 7); // == igual
    console.log(5 != 5); // !=  diferente (negação)
}
console.log("\n====================================\n");
{
// Usando variáveis:
    ...
    console.log(x != y);  // !=  diferente (negação)
}
