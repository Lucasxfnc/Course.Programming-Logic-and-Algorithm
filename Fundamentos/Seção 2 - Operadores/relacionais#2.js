...
// Operadores Relacionais: Um operador relacional compara seus operando e retorna um valor booleano baseado em se a comparação é verdadeira.
{
let x = 1;
let y = "1";
let z = "1";
...
console.log(x === y);  // === igualdade estrita compara valor e tipo das variáveis
console.log(y === z); // === igualdade estrita compara valor e tipo das variáveis

console.log(x != y); // != diferença (negação)
console.log(x !== y);  // !== diferença estrita compara valor e tipo das variáveis
console.log(y !== z); // !== diferença estrita compara valor e tipo das variáveis
}
